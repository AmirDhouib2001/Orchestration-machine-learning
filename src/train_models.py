...
def train_and_log(run_name: str, pipeline: Pipeline, param_grid: dict, x_train, y_train, x_test, y_test):
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        print(f"✅ Scores -> f1: {metrics['f1']:.3f}, roc_auc: {metrics['roc_auc']:.3f}\n")
...
def main():
    ...
    mlflow.set_experiment("Train_3_Models")
    ...
    train_and_log("LogisticRegression_Optimized", lr_pipe, lr_params, x_train, y_train, x_test, y_test)
    ...
    train_and_log("RandomForest_Optimized", rf_pipe, rf_params, x_train, y_train, x_test, y_test)
    ...
    train_and_log("XGBoost_Optimized", xgb_pipe, xgb_params, x_train, y_train, x_test, y_test)
