...
def train_with_optuna(run_name: str, model_type: str, x_train, y_train, x_test, y_test, n_trials=10):
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        print(f"📊 Scores sur le jeu de test -> f1: {metrics['f1']:.3f}, roc_auc: {metrics['roc_auc']:.3f}\n")
...
def main():
    ...
    train_with_optuna("LogisticRegression_Optuna", "LogisticRegression", x_train, y_train, x_test, y_test, n_trials=10)
    train_with_optuna("RandomForest_Optuna", "RandomForest", x_train, y_train, x_test, y_test, n_trials=10)
    train_with_optuna("XGBoost_Optuna", "XGBoost", x_train, y_train, x_test, y_test, n_trials=10)
